#description:   Generate charts on "Feature Effort Stats" sheet.
#prerequisite:  The "Feature Effort Stats" sheet must exist and have data in the right format.
