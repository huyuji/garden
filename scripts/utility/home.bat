...
rem start "" D:\portables\Insomnia.exe
rem start "" D:\private\code\garden\scripts\autohotkey\hotstring.ahk
rem start "" D:\private\code\garden\scripts\autohotkey\jira.ahk
