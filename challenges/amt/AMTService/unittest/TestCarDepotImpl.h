...
class TestCarDepotImpl : public ::testing::Test {
protected:
...
TEST_F(TestCarDepotImpl, listCar)
{
...
TEST_F(TestCarDepotImpl, findCar)
{
...
TEST_F(TestCarDepotImpl, updateCarKeepPlateNo)
{
    boost::shared_ptr<Car> car = depot.findCar(props[0].getPlateNo());
...
TEST_F(TestCarDepotImpl, updateCarPlateNo)
{
    boost::shared_ptr<Car> car = depot.findCar(props[0].getPlateNo());
...
TEST_F(TestCarDepotImpl, deleteCar)
{
    boost::shared_ptr<Car> car = depot.findCar(props[0].getPlateNo());
    depot.deleteCar(car);
